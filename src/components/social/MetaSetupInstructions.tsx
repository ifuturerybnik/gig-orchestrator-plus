    ...
    <div className="space-y-5 text-sm">
      ...
      <div className="rounded-md border bg-muted/30 p-3 text-xs text-muted-foreground">
        ...
        <ul className="mt-1 list-disc pl-5 space-y-0.5">
          ...
          <li>
            <b>Scopes FB:</b>{" "}
            <code className="rounded bg-background px-1 py-0.5">pages_show_list, pages_read_engagement, pages_read_user_engagement, pages_manage_engagement, pages_manage_posts, pages_manage_metadata, business_management, instagram_basic, instagram_content_publish</code>
          </li>
        </ul>
      </div>
    </div>
