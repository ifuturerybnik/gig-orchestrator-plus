export default 
{
  ...
  "organizations": {
    ...
    "counterparties": {
      ...
      "filters": {
        "title": "Filters",
        "search_placeholder": "Search by name, tax ID, email, city, street…",
        "type": "Organization type",
        "country": "Country",
        "city": "City",
        "city_placeholder": "Type city…",
        "source": "Source",
        "linked": "Linked contacts",
        "all_types": "All types",
        ...
        "all_linked": "All",
        "linked_yes": "With linked contacts",
        "linked_no": "Without linked contacts",
        "clear": "Clear filters",
        "no_results": "No counterparties match the current filters."
      },
      "table": {
        "name": "Name",
  ...
  "admin": {
    ...
    "storage": {
      ...
      "global": {
        ...
        "price_hint": "Informational only — billing will be added later.",
        "max_image_mb": "Max image size (MB)",
        "max_video_mb": "Max video size (MB)",
        "central_enabled": "Central storage enabled",
        "central_enabled_hint": "When off — new orgs must connect their own R2.",
      ...
      "bonus": {
        "title": "Free storage bonus — {{name}}",
        "description": "Grant individual extra GB of free quota or paid space.",
        "bonus_free_gb": "Free bonus (GB)",
        "bonus_hint": "Added on top of global free limit (e.g. 2 GB free + 10 GB bonus = 12 GB).",
        "paid_extra_gb": "Paid extra (GB)",
        "note": "Note (optional)",
        "note_placeholder": "e.g. promotional partner, festival X 2026",
        "saved": "Quota saved"
      },
      "r2": {
        "title": "Cloudflare R2 integration — {{name}}",
        "description": "Choose storage mode. In 'own R2' mode enter the organization's Cloudflare R2 credentials — keys are encrypted before storage.",
        "mode_label": "Storage mode",
        "mode_central_hint": "Files go to Concertivo's central bucket.",
        "mode_own_hint": "Files go to THIS org's Cloudflare R2 account — doesn't use our quota.",
        "save_mode": "Save mode",
        "mode_saved": "Mode saved",
        "keys_title": "Organization's Cloudflare R2 credentials",
        "keys_present": "Keys are already saved (enter new values to overwrite).",
        "account_id": "Cloudflare Account ID",
        "bucket": "Bucket",
        ...
        "public_base_url": "Public base URL",
        "public_base_url_hint": "Public URL for files: r2.dev or custom domain (e.g. https://media.org.com).",
        "save_keys": "Save keys",
        "keys_saved": "R2 keys saved",
        "test": "Test connection",
        "test_ok": "OK — mode: {{mode}}, bucket: {{bucket}}",
        "clear": "Clear keys",
        "cleared": "Cleared — organization is back on central storage"
      }
    },
    "ai": {
  ...
  "social": {
    ...
    "account_details": {
      "subtitle": "Connected account details and management actions.",
      "publish_target": "Concertivo posts will be published to:",
      "status": "Status",
      "status_ok": "Active",
      "status_error": "Error",
      ...
      "no_expiry": "Long-lived (auto-refreshed)",
      "scopes": "Granted scopes",
      "last_error": "Last error",
      "what_now": "What you can do now",
      "tip_ai_studio": "Generate and schedule a post in the AI Studio tab.",
      "tip_schedule": "Manage and publish posts manually in Schedule.",
      "tip_inbox": "Reply to comments in the Inbox.",
      "tip_stats": "Review analytics of published posts.",
      "open_external": "Open on platform",
      "open_link": "Click to see details",
    ...
    "schedule": {
      ...
      "sync_meta_limited": "Posts are imported. Meta may still block likes and comments until pages_read_engagement, pages_read_user_engagement and pages_manage_engagement are approved in App Review.",
