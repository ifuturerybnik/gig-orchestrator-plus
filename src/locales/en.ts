export default 
{
  ...
  "correspondence": {
    "mail": {
      ...
      "bulk_delete_confirm": "Delete {{count}} messages from server and database?",
      "bulk_done": "Action performed on {{count}} messages",
      "select_all": "Select all",
      "mailbox_section_org": "Organization mailboxes",
      "mailbox_section_mine": "My mailboxes",
      "folders": {
        "label": "Folders",
        "inbox": "Inbox",
        "sent": "Sent",
