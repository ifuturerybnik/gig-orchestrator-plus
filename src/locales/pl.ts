export default 
{
  ...
  "social": {
    ...
    "schedule": {
      ...
      "sync_meta_limited": "Posty są zaimportowane. Meta może jeszcze blokować polubienia i komentarze do czasu zatwierdzenia uprawnień pages_read_engagement, pages_read_user_engagement i pages_manage_engagement w App Review.",
