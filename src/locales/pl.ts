export default 
{
  ...
  "organizations": {
    ...
    "assistant": {
      ...
      "delete_message_confirm": "Usunąć tę wiadomość? Tej operacji nie da się cofnąć.",
      "orphan_thread": "Rozmowa bez tytułu"
    }
  ...
  "correspondence": {
    "mail": {
      ...
      "bulk_spam": "Do spamu",
      "bulk_mark_read": "Przeczytane",
      "bulk_mark_unread": "Nieprzeczytane",
      "bulk_delete_confirm": "Usunąć {{count}} wiadomości z serwera i bazy?",
      "bulk_done": "Wykonano akcję na {{count}} wiadomościach",
      "select_all": "Zaznacz wszystkie",
      "mailbox_section_org": "Skrzynki organizacji",
      "mailbox_section_mine": "Moje skrzynki",
      "folders": {
        "label": "Foldery",
        "inbox": "Odebrane",
        "sent": "Wysłane",
